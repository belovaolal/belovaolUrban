...
def main():
    ...
    print("Существующее значение:", my_dict.get('Masha'))
    print("Отсутствующее значение:", my_dict.get('Olga'))
    my_dict['Kamila'] = 1981
    my_dict['Artem'] = 1915
    egor_value = my_dict['Egor']  # Сохраняем значение ключа 'Egor' перед удалением
    del my_dict['Egor']
    print("Удаленное значение:", egor_value)
